import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.35a27b98.js";const d=JSON.parse('{"title":"Switch语句(Switch)","description":"","frontmatter":{},"headers":[],"relativePath":"docs/07-switch.md","filePath":"docs/07-switch.md","key":"07-switch.md","conf":{"zh":"Switch语句","en":"Switch","link":"07-switch.md","source":"07-switch.go"},"sourceCode":"https://github.com/fady-mak/cn-gobyexample/blob/main/sources/07-switch.go"}'),p={name:"docs/07-switch.md"},o=l(`<details class="details custom-block"><summary><code>switch</code>语句在许多分支中表达条件。</summary><p><code>Switch</code> statements express conditionals across many branches.</p></details><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"></span></code></pre></div><details class="details custom-block"><summary>下面是一个基本的<code>switch</code>语句。</summary><p>Here’s a basic <code>switch</code>.</p></details><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">package</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">main</span></span>
...
<span class="line"><span style="color:#6A737D;"># I&#39;m a bool</span></span>
<span class="line"><span style="color:#6A737D;"># I&#39;m an int</span></span>
<span class="line"><span style="color:#6A737D;"># Don&#39;t know type string</span></span></code></pre></div>`,13),t=[o];function e(c,r,E,y,i,F){return n(),a("div",null,t)}const m=s(p,[["render",e]]);export{d as __pageData,m as default};
